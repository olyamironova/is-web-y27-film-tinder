...
const SEED_MOVIES = [
  ...
  ['Дюна', 2021, 8.0, ['Фантастика', 'Драма', 'Приключения'], 'Дени Вильнёв', ['Тимоти Шаламе', 'Ребекка Фергюсон']],
  ['Гладиатор', 2000, 8.6, ['Боевик', 'Драма', 'Приключения'], 'Ридли Скотт', ['Рассел Кроу', 'Хоакин Феникс']],
  ['Властелин колец: Братство кольца', 2001, 8.6, ['Фэнтези', 'Приключения', 'Драма'], 'Питер Джексон', ['Элайджа Вуд', 'Иэн Маккеллен']],
  ['Зелёная миля', 1999, 9.1, ['Драма', 'Фэнтези', 'Криминал'], 'Фрэнк Дарабонт', ['Том Хэнкс', 'Майкл Кларк Дункан']],
  ['Бойцовский клуб', 1999, 8.6, ['Драма', 'Триллер'], 'Дэвид Финчер', ['Брэд Питт', 'Эдвард Нортон']],
  ['Список Шиндлера', 1993, 8.8, ['Драма', 'Биография', 'История'], 'Стивен Спилберг', ['Лиам Нисон', 'Бен Кингсли']],
  ['Волк с Уолл-стрит', 2013, 8.0, ['Драма', 'Криминал', 'Биография'], 'Мартин Скорсезе', ['Леонардо ДиКаприо', 'Джона Хилл']],
  ['Джокер', 2019, 8.2, ['Драма', 'Криминал', 'Триллер'], 'Тодд Филлипс', ['Хоакин Феникс', 'Роберт Де Ниро']],
  ['Паразиты', 2019, 8.6, ['Драма', 'Триллер', 'Комедия'], 'Пон Джун-хо', ['Сон Кан-хо', 'Ли Сон-гюн']],
  ['Унесённые призраками', 2001, 8.5, ['Аниме', 'Фэнтези', 'Приключения'], 'Хаяо Миядзаки', ['Руми Хиираги', 'Мию Ирино']],
] as const;
